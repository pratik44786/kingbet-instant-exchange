      ...
      <nav className="flex-1 py-4 px-2 space-y-1">
          ...
          return (
            <Link key={item.path} to={item.path}
              className={cn(
                ...
                active ? "bg-sidebar-accent text-sidebar-primary glow-gold" : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
              )}>
        ...
        {isAdmin && (
          <Link to="/admin"
            className={cn(
              "flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all",
              location.pathname === '/admin' ? "bg-sidebar-accent text-sidebar-primary glow-gold" : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
            )}>
